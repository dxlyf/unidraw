...
export const PREMULTIPLIED_OVER: BlendStateDescriptor = {
...
export class BlendModePass extends FullScreenPass {
  constructor(device: Device, targetFormat?: TextureFormat, sampleCount = 1) {
    super(device, {
      name: "2d-blend-mode",
...
export class LayerPass extends FullScreenPass {
  constructor(device: Device, targetFormat?: TextureFormat, sampleCount = 1, blend?: BlendStateDescriptor) {
    super(device, {

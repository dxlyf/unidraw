...
class GLSampler extends Sampler {
  ...
  constructor(device: WebGL2Device, desc: SamplerDescriptor) {
    ...
    this.gl.samplerParameteri(s, this.gl.TEXTURE_MIN_FILTER, this.minFilterGL(d.minFilter ?? "linear", d.mipmapFilter ?? "linear"));
  ...
  private minFilterGL(min: "nearest" | "linear", mip: "nearest" | "linear"): number {

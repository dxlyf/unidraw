...
import { transformPoint, identityAffine, multiplyAffine } from "../render2d/matrix.js";
import { Color } from "../math/color.js";
import { LinearGradient, sampleStyle } from "../render2d/style.js";
import { fillTriangles } from "../render2d/fill.js";
function ptsClose(p, q, eps = 1e-6) {
...
const rectContour = (x, y, w, h, ccw = false) => ccw
    ? [
        [x, y],
        [x, y + h],
        [x + w, y + h],
...
//# sourceMappingURL=render2d.test.js.map
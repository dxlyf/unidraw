...
export declare const DEFAULT_EULER_ORDER: EulerOrder;
/**
...
export declare class Euler {
    ...
    static readonly RotationOrders: readonly EulerOrder[];
    /** three.js 的同名静态常量，指向 `DEFAULT_EULER_ORDER`。 */
    static readonly DefaultOrder: EulerOrder;
     ...
     */
    setFromRotationMatrix(m: Mat4, order?: EulerOrder, update?: boolean): this;
    /**

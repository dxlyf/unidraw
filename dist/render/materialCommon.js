 ...
 */
export const STANDARD_VERTEX_STATE_INSTANCED = {
    buffers: [
...
export function depthFormatOf(_device, opts) {
    return (opts.depthFormat ?? "depth24plus");
}
export function targetFormatOf(device, opts) {
    if (opts.targetFormat)
        return opts.targetFormat;
    return (device.canvasFormat?.() ?? "rgba8unorm");
}
/**
 ...
 */
export function defaultGroupEntries(options = {}) {
    const entries = [
...
//# sourceMappingURL=materialCommon.js.map
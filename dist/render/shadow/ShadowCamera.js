...
export class ShadowCamera {
     ...
     */
    fitDirectional(direction, center, radius, mapSize, near = 0, far = 0, distance = 1.5) {
        ...
        this._up.set(this._right.y * dz - this._right.z * dy, this._right.z * dx - this._right.x * dz, this._right.x * dy - this._right.y * dx);
        ...
        if (texelWorld > 0) {
            ...
            this._eye.set(this._eye.x + this._right.x * snapX + this._up.x * snapY, this._eye.y + this._right.y * snapX + this._up.y * snapY, this._eye.z + this._right.z * snapX + this._up.z * snapY);
        }
        this._target.copy(center);
        const view = Mat4.lookAt(this._eye.x, this._eye.y, this._eye.z, this._target.x, this._target.y, this._target.z, this._up.x, this._up.y, this._up.z);
     ...
     */
    fitSpot(position, direction, angle, near = 0.1, far = 100, fovScale = 1.05) {

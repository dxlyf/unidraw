...
export function shadowLookupGLSL() {
...
export function shadowLookupWGSL() {
...
export function shadowSamplerName(index) {
    return `u_shadowSampler${index}`;
}
/** 阴影贴图纹理 binding 名称 */
export function shadowTextureName(index) {
    return `u_shadowMap${index}`;
}
//# sourceMappingURL=shadowShaders.js.map
...
export declare function normalizeShadowFilter(value: string | undefined, fallback?: ShadowFilter): ShadowFilter;
/** 滤波方式的着色器编码（打包进 `u_shadowParams2.z`） */
export declare function shadowFilterCode(filter: ShadowFilter): number;
...
//# sourceMappingURL=ShadowSettings.d.ts.map